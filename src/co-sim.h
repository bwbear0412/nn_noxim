...
////////////////HotSpot setting//////////////////////////////////////////////////////
// unit: ns
#define TEMP_REPORT_PERIOD      1e4 //1e6 //1e-4		 //1e6 should be the same with Sim_cycle_num_per_10ms_interval in NoximPower.cpp
// Initial temperature
#define INIT_TEMP               298.15 //350.15//77 kalvin degree
#define INIT_TEMP_80            348 //353
#define TEMP_THRESHOULD         80//70
// Area(Side) of Router & Tile(unit: meter)
