...
NoximPower::NoximPower() {
    ...
    // fitting target: steady state avergate temperature = 80-core paper's avg temp.
    ...
    accEnergy_to_SteadyState_Power_coeff = (Energy_Extrapolation_Factor / Total_Simulation_Time_in_Sec) * Power_Scaling_Factor;
